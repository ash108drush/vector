...
/*
    ...
    }
    {
        ...
        assert(Obj::num_copied == 1);
        assert(Obj::num_default_constructed == SIZE);
       // std::cout << "size" << SIZE << "Alive obj" << Obj::GetAliveObjectCount() << std::endl;
       // std::cout << "siz:" << SIZE +2 << " equal?" << Obj::GetAliveObjectCount() << std::endl;
...

    {
     ...
     //   std::cout << Obj::num_copied  << std::endl;
     //   std::cout << Obj::num_default_constructed  << std::endl;
    ...
    */
    {
        ...
        assert(&*pos == &v[3]);
        assert(v[3].id == ID);
        std::cout << v[3].id << std::endl;
        assert(v[3].name == "Ivan");
        assert(Obj::num_copied == 0);
        assert(Obj::num_default_constructed == SIZE);
        assert(Obj::num_constructed_with_id_and_name == 1);
        assert(Obj::num_moved == old_num_moved + 1);
        std::cout << Obj::num_move_assigned << "eq:" <<SIZE - 3 << std::endl;
